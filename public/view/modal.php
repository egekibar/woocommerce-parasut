...
<script>
    $('button').click(function (){
        ...
        setTimeout(() => {
            $('[loading]').show()
            $.ajax("admin.php?action=parasut_<?= $view_modal['ajax_action'] ?>&start=true", {
